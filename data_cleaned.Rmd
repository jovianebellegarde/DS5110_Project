...
# Denominator File
denom_data <- fread("./link2020usden.csv",select=c('brthwgt','dob_tt','bfacil','pwgt_r','wtgain','mrace6','ilive','meduc','bfacil3','rf_pdiab','rf_gdiab','rf_phype','rf_ghype','rf_ehype','rf_ppb','rf_inft','rf_drg','rf_art','rf_cesar','no_risks', 'mager9', 'dob_yy', 'dob_mm','dob_wk', 'sex'))
...
births <- balanced_data %>% select(-c('brthwgt.x','brthwgt.y', 'dob_tt.x','dob_tt.y',
                                                  'bfacil.x','bfacil.y', 
