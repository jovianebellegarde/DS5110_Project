...
```{r}
ggplot(full_data_clean, aes(x=Race_Category)) + 
  geom_bar()+ 
...
# Distribution of Age 
  ## Notes: Race is more evenly distributed after oversampling
```{r}
ggplot(full_data_clean, aes(x=Age_Category)) + 
  geom_bar()+ 
  theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1)) +
...
```{r}
ggplot(full_data_clean, aes(x=risk_level)) + 
  geom_bar()+ 
  theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1)) +
...
```{r}
ggplot(full_data_clean, aes(x=Educ_Category)) + 
  geom_bar()+ 
  theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1)) +
