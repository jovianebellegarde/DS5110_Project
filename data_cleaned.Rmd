...
death_cases <- mydata[mydata$death == 1, ]
alive_cases <- mydata[mydata$death == 0, ]
...
```{r}
library(MASS)
# Use stepAIC to select the best number of variables to include in the model based on AIC
