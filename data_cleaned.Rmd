...
```
# Conclusions
  # The full model (including Race variable) provides a significantly better 
...
# Meduc (education level) is negatively associated with the outcome variable. 
  # For every unit increase in meduc, the odds of the outcome decrease by a factor of 0.89. 
  # This suggests that individuals with higher levels of education are less likely to experience the outcome compared to those with lower levels of        education.


# Risk_level_cat (health risks prior to giving birth) is positively associated with the outcome variable. 
  # Specifically, for individuals in the higher risk level category, the odds of the outcome are 1.97 times higher compared to those in the lower risk     level category.
  # This suggests that individuals with higher levels of health risks prior to giving birth are more likely to experience the outcome compared to those     with lower levels of health risks.

# Mrace6 (race) has an OR of 1.08, which is very close to 1. 
  # This suggests that race may not be strongly associated with the outcome variable in this particular model.

# Mager9 (age) is negatively associated with the outcome variable. 
  # Specifically, for every unit increase in mager9, the odds of the outcome decrease by a factor of 0.96. 
  # This suggests that older individuals are less likely to experience the outcome compared to younger individuals.
